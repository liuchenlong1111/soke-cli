...
import (
	...
	learningProfileShortcuts "codeup.aliyun.com/5edbc121d1d1abe63b55f1c7/soke/soke-cli/shortcuts/learning_profile"
	"codeup.aliyun.com/5edbc121d1d1abe63b55f1c7/soke/soke-cli/shortcuts/common"
)

func NewLearningProfileCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "learning-profile",
		Short: "学习档案相关接口",
	}

	shortcuts := learningProfileShortcuts.Shortcuts()
