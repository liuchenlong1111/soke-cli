...
var PointListLogs = common.Shortcut{
	Service:     "point",
	Command:     "+list-logs",
	Description: "List point logs",
	Risk:        "read",
	UserScopes:  []string{"point:logMeta:readonly"},
	BotScopes:   []string{"point:logMeta:readonly"},
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		data, err := runtime.CallAPI("GET", "/point/logMeta/list", params, nil)
		if err != nil {
			return err
		}
