...
var TrainingListCategories = common.Shortcut{
	Service:     "training",
	Command:     "+list-categories",
	Description: "List training categories",
	Risk:        "read",
	UserScopes:  []string{"training:category:readonly"},
	BotScopes:   []string{"training:category:readonly"},
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		data, err := runtime.CallAPI("GET", "/training/category/list", params, nil)
		if err != nil {
			return err
		}
