...
var CertificateListCategories = common.Shortcut{
	Service:     "certificate",
	Command:     "+list-categories",
	Description: "List certificate categories",
	Risk:        "read",
	UserScopes:  []string{"certificate:category:readonly"},
	BotScopes:   []string{"certificate:category:readonly"},
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		data, err := runtime.CallAPI("GET", "/certificate/category/list", params, nil)
		if err != nil {
			return err
		}
