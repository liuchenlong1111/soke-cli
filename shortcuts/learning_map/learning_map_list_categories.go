...
var LearningMapListCategories = common.Shortcut{
	Service:     "learning_map",
	Command:     "+list-categories",
	Description: "List learning map categories",
	Risk:        "read",
	UserScopes:  []string{"learningMap:category:readonly"},
	BotScopes:   []string{"learningMap:category:readonly"},
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		data, err := runtime.CallAPI("GET", "/learningMap/category/list", params, nil)
		if err != nil {
			return err
		}
