...
var ExamListExams = common.Shortcut{
	Service:     "exam",
	Command:     "+list-exams",
	Description: "List exams",
	Risk:        "read",
	UserScopes:  []string{"exam:exam:readonly"},
	BotScopes:   []string{"exam:exam:readonly"},
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		data, err := runtime.CallAPI("GET", "/exam/exam/list", params, nil)
		if err != nil {
			return err
		}
		...
		runtime.OutFormat(data, nil, func(w io.Writer) {
			...
			for _, item := range list {
				exam, _ := item.(map[string]interface{})
				if exam != nil {
